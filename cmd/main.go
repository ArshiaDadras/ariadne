...
func main() {
	...
	// P1 := pkg.Point{Longitude: 51.372723607382994, Latitude: 35.792019008390966}
	// P2 := pkg.Point{Longitude: 51.371323391458816, Latitude: 35.79170002313525}
	// P3 := pkg.Point{Longitude: 51.37272618815106, Latitude: 35.79319153141927}
